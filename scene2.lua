...
local function nextScene2Event ( event )
...
function scene: createScene (event)
		...
		local scene2Image = display.newImageRect (  "images/final2.png", 300, 400 );
		scene2Image.x = _W *0.5; scene2Image.y =210
		
screenGroup:insert(background)
screenGroup:insert(scene2Image) 
end
...
local nextScene2Button = widget.newButton
 
	{
			...
			id = "Next_Scene2_Button",
			onEvent = nextScene2Event,
	}
	...
	local skipButton = widget.newButton
{
	...
	button:insert(nextScene2Button)
